...
export const DEFAULT_LOCATION_OPTIONS: LocationOption[] = [
  {
    ...
    city: 'Noida',
    state: 'Uttar Pradesh',
    coordinates: { lat: 28.209, lng: 77.1295 },
  },
  {
    id: '2',
    name: 'Greater Noida',
  ...
  },
  {
    ...
    city: 'Faridabad',
    state: 'Haryana',
    coordinates: { lat: 28.4089, lng: 77.298 },
  },
  {
    id: '6',
    name: 'Bangalore',
  ...
  },
  {
    ...
    city: 'Mumbai',
    state: 'Maharashtra',
    coordinates: { lat: 19.076, lng: 72.8855 },
  },
];
...
const LocationSelector: React.FC<LocationSelectorProps> = ({
  ...
  const locations: LocationOption[] = providedLocations || DEFAULT_LOCATION_OPTIONS;
